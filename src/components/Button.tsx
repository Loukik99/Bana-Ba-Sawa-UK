...
export default function Button({
  ...
  if (to) {
    return (
      <Link to={to} className={classes} onClick={onClick} aria-disabled={disabled || undefined}>
        {children}
      </Link>
    );
  }
  ...
  if (href) {
    return (
      <a href={href} className={classes} onClick={onClick} aria-disabled={disabled || undefined}>
        {children}
      </a>
    );
  }
